"""Shared pytest fixtures for LegalClaw L1 unit tests."""
import os
import sys
...
import pytest
from legal_helpers import init_all_tables, get_conn, build_env


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with core + legalclaw schema."""
...
@pytest.fixture
def env(conn):
    """Full legal environment: company, accounts, FY, CC, customer, client_ext, matter, trust."""
